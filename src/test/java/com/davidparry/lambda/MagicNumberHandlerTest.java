...
class MagicNumberHandlerTest {
    ...
    @Test
    void testValidNumericMagicNumber() throws Exception {
        // Arrange
        ...
        assertEquals("Successfully processed magic number: 5", responseBody.get("message").asText());
    }
    ...
    void testNonNumericMagicNumber() throws Exception {
        ...
        assertTrue(responseBody.get("error").asText().contains("I34"));
    ...
    @Test
    void testValidEvenNumber() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
