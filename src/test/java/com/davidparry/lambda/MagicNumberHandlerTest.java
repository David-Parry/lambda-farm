 ...
 * Tests cover validation scenarios for the magicNumber query parameter
 */
class MagicNumberHandlerTest {
    ...
    @Test
    void testValidIntegerInput_ReturnsSuccess() throws Exception {
        // Arrange
    ...
    @Test
    void testEmptyMagicNumberValue_Returns400() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
    ...
    @Test
    void testNegativeNumber_ReturnsSuccess() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
