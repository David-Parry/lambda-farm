...
class MagicNumberHandlerTest {
    ...
    @Test
    void testInvalidMagicNumber_WithLetters() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "12I");
        request.setQueryStringParameters(queryParams);
        ...
        assertTrue(responseBody.get("error").asText().contains("12I"));
    ...
    @Test
    void testMagicNumberWithSpecialCharacters() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
