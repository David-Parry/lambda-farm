...
class MagicNumberHandlerTest {
    ...
    void testValidNumericInput() throws Exception {
        ...
        queryParams.put("magicNumber", "34");
        ...
        assertEquals(34, responseBody.get("magicNumber").asInt());
        assertTrue(responseBody.get("isEven").asBoolean());
        assertEquals(1156, responseBody.get("squared").asInt());
    ...
    void testNonNumericInput() throws Exception {
        ...
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "34f");
        request.setQueryStringParameters(queryParams);
        request.setHttpMethod("GET");
    ...
    void testMissingParameter() throws Exception {
        ...
        JsonNode responseBody = objectMapper.readTree(response.getBody());
        assertEquals(400, responseBody.get("statusCode").asInt());
        assertTrue(responseBody.get("error").asText().contains("Missing required 'magicNumber' query parameter"));
    }
    ...
    @Test
    void testWhitespaceOnlyParameter() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "   ");
    ...
    void testLargeNumber() throws Exception {
        ...
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", String.valueOf(Integer.MAX_VALUE));
        request.setQueryStringParameters(queryParams);
        request.setHttpMethod("GET");
    ...
    @Test
    void testNumberWithLeadingWhitespace() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "  42  ");
