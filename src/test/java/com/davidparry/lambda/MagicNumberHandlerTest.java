...
class MagicNumberHandlerTest {
    ...
    @Test
    void testValidMagicNumber_Odd() throws Exception {
        // Arrange
    ...
    @Test
    void testValidMagicNumber_Even() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
    ...
    @Test
    void testValidMagicNumber_Negative() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
    ...
    void testInvalidMagicNumber_NonNumeric() throws Exception {
        ...
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "34t");
        request.setQueryStringParameters(queryParams);
    ...
    @Test
    void testInvalidMagicNumber_AlphaNumeric() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
