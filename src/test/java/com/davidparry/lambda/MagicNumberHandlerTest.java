...
class MagicNumberHandlerTest {
    ...
    @Test
    void testValidIntegerParameter() throws Exception {
        // Arrange
    ...
    void testMissingQueryParameters() throws Exception {
        ...
        assertTrue(responseBody.get("error").asText().contains("magicNumber query parameter is required"));
    }
    ...
    @Test
    void testScientificNotationParameter() throws Exception {
        // Arrange - This is the bug scenario from the issue
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("magicNumber", "12e");
        request.setQueryStringParameters(queryParams);
        ...
        JsonNode responseBody = objectMapper.readTree(response.getBody());
        assertEquals(400, responseBody.get("statusCode").asInt());
        assertTrue(responseBody.get("error").asText().contains("magicNumber must be a valid integer"));
    }

    @Test
    void testNonNumericParameter() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
    ...
    @Test
    void testDecimalParameter() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
    ...
    @Test
    void testValidIntegerWithWhitespace() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
