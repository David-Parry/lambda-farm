...
class MagicNumberHandlerTest {
    ...
    void testNonNumericMagicNumber() throws Exception {
        ...
        JsonNode responseBody = objectMapper.readTree(response.getBody());
        assertEquals("INVALID_MAGIC_NUMBER", responseBody.get("code").asText());
        assertTrue(responseBody.get("error").asText().contains("valid integer"));
        assertEquals("23i", responseBody.get("receivedValue").asText());
    }
    ...
    void testMissingMagicNumberParameter() throws Exception {
        ...
        JsonNode responseBody = objectMapper.readTree(response.getBody());
        assertEquals("MISSING_PARAMETER", responseBody.get("code").asText());
        assertTrue(responseBody.get("error").asText().contains("missing"));
    }
    ...
    void testEmptyMagicNumberValue() throws Exception {
        ...
        JsonNode responseBody = objectMapper.readTree(response.getBody());
        assertEquals("EMPTY_PARAMETER", responseBody.get("code").asText());
    }
    ...
    @Test
    void testMagicNumberWithLeadingWhitespace() throws Exception {
        // Arrange
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setHttpMethod("GET");
        Map<String, String> queryParams = new HashMap<>();
